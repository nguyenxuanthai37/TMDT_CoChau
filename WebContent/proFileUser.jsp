...
<%-- 								<span><%=u.getSCORE()%></span> --%>
					...
					<div class="tab-pane" id="tindaluu">
						<%@ include file="tindaluu.jsp"%>
					</div>
					<div class="tab-pane" id="lstimkiem"><%@ include
							file="lichsutimkiem.jsp"%></div>
					<div class="tab-pane" id="friend"></div>
					<div class="tab-pane" id="acc-tichdiem"><%@ include
							file="tichdiem.jsp"%></div>
					<div class="tab-pane" id="history-gd"><%@ include
							file="lichsugiaodich.jsp"%></div>
					<div class="tab-pane" id="payment"><%@ include
							file="thelienket.jsp"%></div>
						...
						<form role="form" action="ChangeInformatonUser" method="post">
							...
							<div class="form-group row">
								<label class="col-lg-3 col-form-label form-control-label">Giới
									tính</label>
								<div class="col-lg-9">
									<input type="radio" name="gender" value="1" checked="checked">Nam <input
										type="radio" name="gender" value="0">Nữ
								</div>
							</div>
			...
			<div class="col-lg-4 order-lg-1 text-center">
				...
				<input type="file" id="file1" name="image" accept="image/*" capture
					style="display: none" />
				<imgp src="//placehold.it/<%=u.getAVATAR()%>>" id="upfile1"
					style="cursor: pointer" />


				<div><%=u.getFIRSTNAME() + " " + u.getLASTNAME()%></div>
			</div>
