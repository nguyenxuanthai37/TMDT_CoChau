...
<style type="text/css">
@import
	url('https://fonts.googleapis.com/css?family=Roboto|Taviraj&display=swap')
	;
...
@
keyframes top {from { transform:translate(0rem, 0);
...
@
keyframes bottom {from { transform:translate(-11.5rem, 0);
...
.dangtin::after {
	...
	top: 3rem;
	left: 13rem;
	animation: bottom 2s cubic-bezier(0.68, -0.55, 0.265, 1.55) 0.5s
		infinite alternate;
}
				...
				<div class="navbar-inner">
					...
					<div class="main-nav-wrapper">
						<ul class="main-navigation list-inline" id="main-menu">
							...
							<li><div class="containerdangtin">
									<a class="dangtin" href="editcontent.jsp">đăng tin</a>
								</div> <!-- End of .main-navigation --></li>
						</ul>
					</div>
					<!-- End of .main-nav-wrapper -->
					<div class="navbar-extra-features ml-auto">
						<i > </i> <a class="far fa-user"  href="User"></a>
					</div>
